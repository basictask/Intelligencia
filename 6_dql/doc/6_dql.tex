...
\only<2>{A gyakorlatban a $Q(s,a)$ érték úgy áll elő, hogy a $V(s)$ állapot-értékhez hozzáadódik a választott cselekvés előnyének és az összes cselekvés előnyének különbsége:
\begin{block}{}
\vspace{-0.5cm}
\[
