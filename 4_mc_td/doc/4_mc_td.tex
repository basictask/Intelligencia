...
\begin{frame}{Példa Monte Carlo értékbecslésre}
...
\begin{frame}{Monte Carlo értékbecslés több látogatás esetén}
\begin{columns}
\begin{column}{.5\textwidth}
