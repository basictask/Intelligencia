...
\begin{columns}
\begin{column}{0.5\textwidth}
\only<1>{A legegyszerűbb verziókezelés, ha a fejlesztő kézzel átmásol egy mappába fájlokat. Ezek lehetnek idő bélyegzett mappák is, ha okos a fejlesztő. Ez a megoldás nagyon egyszerű, viszont fogékony a hibákra, mert sok a manuális munka. Ezenkívül sok benne a redundáns adat is, mert a nem változtatott adatot is el kell tárolni. Ezért hozták létre a lokális verziókezelőket.}
...
\begin{column}{0.6\textwidth}
\begin{center}
\includegraphics[width=9cm, height=9cm, keepaspectratio]{images/git_6.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}
\includegraphics[height=6cm, keepaspectratio]{images/git_7.png}
\end{center}}
\only<2>{
A checkout művelete átírja a HEAD mutató pozícióját a megjelölt fejlesztési ágra.
\begin{center}
\includegraphics[height=6cm, keepaspectratio]{images/git_8.png}
\end{center}}
\end{frame}
...
\begin{center}
\includegraphics[height=6cm, width=14cm, keepaspectratio]{images/git_9.png}
\end{center}
\end{frame}
...
\begin{column}{0.5\textwidth}
\begin{center}
\only<1>{\includegraphics[width=7cm, height=7cm, keepaspectratio]{images/git_15.png}}
\only<2>{\includegraphics[width=7cm, height=7cm, keepaspectratio]{images/git_16.png}}
\only<3>{\includegraphics[width=7cm, height=7cm, keepaspectratio]{images/git_17.png}}
\end{center}
\end{column}
\end{columns}
\end{frame}
